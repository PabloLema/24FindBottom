 ...
 * {@link PromocionesFragment.OnFragmentInteractionListenerPr} interface
...
public class PromocionesFragment extends Fragment {
    ...
    private OnFragmentInteractionListenerPr mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteractionPr(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListenerPr) {
            mListener = (OnFragmentInteractionListenerPr) context;
        } else {
     ...
     */
    public interface OnFragmentInteractionListenerPr {
        // TODO: Update argument type and name
        void onFragmentInteractionPr(Uri uri);
    }
}
